...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'firebird.butler.fbdp_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _FBDPOPENDATAFRAME._serialized_start=77
  _FBDPOPENDATAFRAME._serialized_end=202
